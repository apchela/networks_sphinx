...
* Вместо семи уровней :ref:`OSI <levels-osi>` TCP/IP имеет четыре, потому что многие функции :ref:`OSI <section-osi> объединили для удобства.
В TCP/IP нет отдельного Сеансового и Представительского уровней — их функции выполняет Прикладной уровень.
